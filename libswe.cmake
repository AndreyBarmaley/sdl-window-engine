...
option(WITH_JSON "add json format support" ON)
option(WITH_LUA "add lua support" OFF)
option(WITH_DLL "add load shared libs support, with -ldl" OFF)
option(WITH_XML "add tinyxml2 support" OFF)
option(WITH_ICONV "usage iconv for Tools::stringEncode" OFF)
option(DISABLE_NETWORK "disable library SDL_net" ON)
option(DISABLE_AUDIO "disable library SDL_mixer" OFF)
option(DISABLE_IMAGE "disable library SDL_image" OFF)
option(DISABLE_TTF "disable library SDL_ttf" OFF)
option(DISABLE_TERMGUI "disable build termwin_gui" ON)
option(SWE_DEBUG "scene debug hotkeys" OFF)
option(BUILD_DEBUG_MESSAGES "DEBUG messages" ON)
option(BUILD_STACKTRACE "stack trace on exception" ON)
