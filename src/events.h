...
public:
    ...
    bool                isClick(const Rect & rt) const { return (rt & coord1.position()) && (rt & coord2.position()); }
    ...
    bool                isButtonLeft(void) const { return coord1.isButtonLeft(); }
    bool                isButtonRight(void) const { return coord1.isButtonRight(); }
    bool                isButtonMiddle(void) const { return coord1.isButtonMiddle(); }
    bool                isButtonX1(void) const { return coord1.isButtonX1(); }
    bool                isButtonX2(void) const { return coord1.isButtonX2(); }
};
